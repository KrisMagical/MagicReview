"""GitHub Markdown formatting for ReviewAgent reports."""
...
SUMMARY_MARKER = "<!-- reviewagent-summary -->"


def inline_marker(issue: dict[str, Any]) -> str:
    return f"<!-- reviewagent-inline:{issue['type']}:{issue['file']}:{issue['line']} -->"
...
def format_summary_comment(result: dict[str, Any], *, errors: list[str] | None = None) -> str:
    ...
    lines.extend(["", "Generated by ReviewAgent."])
    return "\n".join(lines)
